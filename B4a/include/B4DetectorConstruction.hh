...
class B4DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    const G4VPhysicalVolume* GetSensiPV() const;
  ...
  private:
    ...
    G4VPhysicalVolume*   fSensiPV;    // the sensitive layer physical volume
...
inline const G4VPhysicalVolume* B4DetectorConstruction::GetSensiPV() const  { 
  return fSensiPV; 
}
